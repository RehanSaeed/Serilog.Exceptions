namespace Serilog.Exceptions.Destructurers
{
    ...
    {
        private static readonly List<Type> TargetTypesList = new List<Type>
        {
        ...
        private static readonly Type[] TargetTypesArray;

        static ExceptionDestructurer()
        {
#if NET45
            foreach (var dangerousType in GetNotHandledByMonoTypes())
            {
                ...
                if (type != null)
                {
                    TargetTypesList.Add(type);
                }
            }
#endif

            TargetTypesArray = TargetTypesList.ToArray();
        }

        public virtual Type[] TargetTypes { get => TargetTypesArray; }
