namespace Serilog.Exceptions.Test.Destructurers
{
    ...
    public class FastReflectionBasedDestructurerTest
    {
        private readonly FastReflectionBasedDestructurer destructurer;

        public FastReflectionBasedDestructurerTest()
        {
            this.destructurer = new FastReflectionBasedDestructurer();
        }
